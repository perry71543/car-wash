      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-16">
          {[
            ...
            { icon: '📞', label: '客服電話', value: '02-XXXX-XXXX', sub: '週一至週五 09:00–18:00' },
        ...
        {sent ? (
          <div className="text-center py-16 border border-neon/20 bg-neon/5" role="alert">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="contact-name" className="text-xs text-zinc-400 font-display uppercase tracking-wider block mb-2">姓名 *</label>
                  <input
                    id="contact-name"
                    type="text"
                    name="name"
                ...
                <div>
                  <label htmlFor="contact-email" className="text-xs text-zinc-400 font-display uppercase tracking-wider block mb-2">電子郵件 *</label>
                  <input
                    id="contact-email"
                    type="email"
                    name="email"
              ...
              <div>
                <label htmlFor="contact-subject" className="text-xs text-zinc-400 font-display uppercase tracking-wider block mb-2">主旨 *</label>
                <select
                  id="contact-subject"
                  name="subject"
                  value={form.subject}
              ...
              <div>
                <label htmlFor="contact-message" className="text-xs text-zinc-400 font-display uppercase tracking-wider block mb-2">訊息內容 *</label>
                <textarea
                  id="contact-message"
                  name="message"
                  value={form.message}
